...
- o código que buscou a informação online *já é* documentação
    - de onde os dados foram raspados, 
    - como foi processado
...
- permite rastrear a versão documento
    - sabe o "*putz, não podiam ter jogado fora aquele gráfico*" e o "*é, ninguém mais consegue achar o arquivo de imagem e nem cópia da versão anterior*"?
...
- bônus: permite documentar quais alterações foram feitas
...
- o chunk que funciona em um documento pode servir de início e ser adaptado para uma finalidade próxima em outro documento
